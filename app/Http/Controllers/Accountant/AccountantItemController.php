...
class AccountantItemController extends Controller
{
        ...
        public function create_item(){
            ...
            return view('accountant.home.item.create_item', compact('menu', 'supplier', 'submenus'));
        }
        //==================End Method=======================//
    ...
    //=====================End Method==========================//
     ...
     public function update_item($id)
     {
         ...
         $supplier = Supplier::all();
         $submenu = Submenu::all();
         return view('accountant.home.item.update_item',compact('item','menu','supplier','submenu'));
     }
     //=====================End Method==========================//
     //==================Store Update Item =======================//
