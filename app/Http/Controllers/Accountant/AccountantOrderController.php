...
class AccountantOrderController extends Controller
{
    ...
    public function order() {
        ...
        return view('accountant.home.order.list_order',compact('count','orders','orderStatuses'));
    }
     //==================Update Order Status=======================//
    ...
    public function create_order() {
        $item = Item::all();
        return view('accountant.home.order.create_order',compact('item'));
    }
    //==================Store create order=======================//
    ...
    public function update_order($id)
    {
        ...
        $items = Item::all();
        return view('accountant.home.order.update_order',compact('items','order'));
    }
    //==================Store Update Order =======================//
    ...
    public function delete_order($id_order) {
        ...
        if ($order) {
            ...
            $order->delete();
            return redirect('/accountant/order')->with("success", "Order deleted successfully!");
        }
    ...
    public function invoice($orderId)
    {
        ...
        return view('accountant.home.order.invoice', compact('order'));
    }
    ...
    //     $order = Order::with('orderItems')->find($orderId);
    //     $pdf = PDF::loadView('accountant.home.order.invoice', compact('order'));
