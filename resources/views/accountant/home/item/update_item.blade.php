            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{url('/accountant/update_item/'.$item->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="item_origin_price" type="float" placeholder="Enter origin price" value="{{$item->origin_price}}">
                                </div>
                            </div>
                            <div class="form-group row">
