...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li>
                <a class="app-menu__item active" href="{{url('/admin/submenu')}}" >
                    <i class="fas fa-utensils"></i>
                    &nbsp;&nbsp;&nbsp;
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Create Sub Menu</h1>          
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Sub Menus</li>
                <li class="breadcrumb-item active"><a href="#">Create Sub Menus</a></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('admin.create_submenu.post') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-md-3">Submenu name</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="submenu_name" type="text" placeholder="Enter name">
                                    @error('submenu_name')
