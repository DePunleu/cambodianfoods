    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">All Sub Menus</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="badge badge-warning edit" href="{{url('/admin/update_submenu/'.$row->id)}}" title="Update" data-toggle="tooltip">
