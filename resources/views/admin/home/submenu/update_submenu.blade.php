...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Sub Menus</h1>          
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Sub Menus</li>
                <li class="breadcrumb-item active"><a href="#">Update Sub Menus</a></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{url('/admin/update_submenu/'.$submenu->id)}}" enctype="multipart/form-data">          
                            @csrf <!-- to make form active -->
                            {{-- @method('PUT') --}}
                            <div class="form-group row">
                                <label class="control-label col-md-3">Name</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="submenu_name" type="text" value="{{$submenu->submenu_name}}">
                                    @error('submenu_name')
