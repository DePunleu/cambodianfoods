...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Create Suppliers</h1>          
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Suppliers</li>
                <li class="breadcrumb-item active"><a href="#">Create Suppliers</a></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('admin.create_supplier.post') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-md-3">Name</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="supplier_name" type="text" placeholder="Enter name">
                                    @error('supplier_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" rows="4" name="supplier_description" placeholder="Enter description"></textarea>
