<aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      {{-- End Session Active --}}
      <li>
        <a class="app-menu__item active" href="{{url('seller/dashboard')}}">
      ...
      {{-- <li class="treeview " >
        ...
        <ul class="treeview-menu"> --}}
          ...
          {{-- End Session Active --}}
          {{-- <li>
            <a class="treeview-item " href="{{ url('seller/update_password') }}">
          ...
          {{-- End Session Active --}}
          {{-- <li>
            <a class="treeview-item " href="{{url('seller/update_details')}}">
              <i class="icon fa fa-circle-o"></i> 
              Update Details
            </a>
          </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li>
            <a class="treeview-item" href="{{url('/seller/users')}}">
              <i class="icon fa fa-circle-o"></i> All Users
            </a>
          </li>
          <li>
            <a class="treeview-item" href="{{url('/seller/create_users')}}">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li>
            <a class="treeview-item" href="{{url('/seller/menu')}}">
              <i class="icon fa fa-circle-o"></i> Show Menus
            </a>
          </li>
          <li>
            <a class="treeview-item" href="{{url('/seller/create_menu')}}">
